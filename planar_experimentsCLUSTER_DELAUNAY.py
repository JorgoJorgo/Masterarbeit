...
def experiments(switch="all", seed=33, rep=100, num_nodes=60, f_num=0, main_loop_index=0):
    ...
    if switch in ["planar", "all"]:
        ...
        filename = f"results_cluster_delaunay/benchmark-planar-{method.lower()}-{attack}-FR{main_loop_index}"
...
if __name__ == "__main__":
    start_FR = 28      #Anfangswert um die Anfänglichen Experimente zu skippen, da Algorihtmen erst später Probleme bekommen
