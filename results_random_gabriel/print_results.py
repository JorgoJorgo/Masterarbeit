...
def plot_success(title_prefix, algo_success, fr_indices):
    ...
    if algo_success:
        ...
        plt.title("Durchschnittliche Resilienz pro Failure Rate (Gabriel, Randomisierte Fehler)")
...
def plot_hops(title_prefix, algo_hops, fr_indices):
    ...
    if algo_hops:
        ...
        plt.title("Durchschnittliche Hops pro Failure Rate (Gabriel, Randomisierte Fehler)")
        plt.xlabel("Failure Rate")
...
# Beispielaufruf:
directory = 'results_random_gabriel'
